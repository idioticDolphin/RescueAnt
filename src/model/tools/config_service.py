...
def load_config(configs:dict=None):
    ...
    try:
        ...
        anchor_tokens_identity = _csv_list(configs.get("anchor_tokens[identity]", ""))
        anchor_tokens_exclude = _csv_list(configs.get("anchor_tokens[exclude]", ""))
        ...
        leaving_site_penalty = _opt_float(configs, "leaving_site_penalty", 0.0)
        leaving_site_exempt_min_weight = _opt_float(configs, "leaving_site_exempt_min_weight", 5.0)
        ...
        _session_config = Config(
            ...
            anchor_tokens_identity = anchor_tokens_identity,
            anchor_tokens_exclude = anchor_tokens_exclude,
            anchor_identity_bonus = _opt_float(configs, "anchor_identity_bonus", 2.0),
            anchor_exclude_penalty = _opt_float(configs, "anchor_exclude_penalty", 1.5),
            ...
            leaving_site_exempt_min_weight = leaving_site_exempt_min_weight,
